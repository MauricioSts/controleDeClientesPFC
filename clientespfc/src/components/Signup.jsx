  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p style={{ color: "#FFFFFF" }}>Comece a gerenciar seus pedidos agora</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5" style={{ color: "#3B82F6" }} />
            <input
              type="text"
              value={name}
